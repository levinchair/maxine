...
export class DataTable4Service{ 
    private _city;
    ...
    private updatedData2 = new Subject<view4[]>();
    ...
    setCity(city: string){
      ...
      getView2(){
            ...
            {
                    this.http.get<{viewData:view4[]}>(`http://localhost:3000/view4/${this._city}/${this._neighborhood}`)
                    .subscribe( (view) => {        
                      this.viewData=view;
            ...
            {
                    this.http.get<{viewData:view4[]}>(`http://localhost:3000/view4/${this._city}`)
                    .subscribe( (view) => {        
                      this.viewData=view;
                      console.log("viewData",this.viewData)
                      this.dupviewData.length=0;
