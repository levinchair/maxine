...
router.get("/showgeometry/:city/:hood?",(req,res,next)=>{
    ...
    //
    if(this.hood !== undefined && this.city !== undefined){
      db.find({"properties.SPA_NAME":this.hood,"properties.PAR_CITY":this.city},
			        {_id:1, type:1,"properties.PARCELPIN":1,"properties.PAR_CITY":1,
  ...
  }else if(this.hood === undefined && this.city != undefined){
    db.find({"properties.PAR_CITY":this.city},
            {_id:1, type:1,"properties.PARCELPIN":1,"properties.PAR_CITY":1,
            "properties.SPA_NAME":1,"geometry.type":1,"geometry.coordinates":1},
    (err,result)=>{
      if(err) {
