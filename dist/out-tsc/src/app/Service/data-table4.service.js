...
var DataTable4Service = /** @class */ (function () {
    function DataTable4Service(http) {
        this.http = http;
        this.dupviewData = [];
    ...
    DataTable4Service.prototype.setCity = function (city) {
        this._city = city;
        // console.log(this._city);
    };
    DataTable4Service.prototype.setHood = function (hood) {
        this._neighborhood = hood;
        // console.log(this._neighborhood);
    };
    DataTable4Service.prototype.sendCity = function () {
        // console.log(this._city);
        return this._city;
    };
    DataTable4Service.prototype.sendHood = function () {
        // console.log(this._neighborhood);
        return this._neighborhood;
    };
    DataTable4Service.prototype.getView2 = function () {
        var _this = this;
        console.log("city", this._city);
        console.log("hood", this._neighborhood);
        if (this._city != null && this._neighborhood != null) {
            this.http.get("http://localhost:3000/view4/" + this._city + "/" + this._neighborhood)
            ...
            this.http.get("http://localhost:3000/view4/" + this._city)
                .subscribe(function (view) {
                _this.viewData = view;
                console.log("viewData", _this.viewData);
                _this.dupviewData.length = 0;
    ...
    DataTable4Service = __decorate([
        Injectable({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [HttpClient])
    ], DataTable4Service);
    return DataTable4Service;
}());
export { DataTable4Service };
//# sourceMappingURL=data-table4.service.js.map