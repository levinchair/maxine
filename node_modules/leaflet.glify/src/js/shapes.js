...
8    // ----------------------------
  ...
  resetVertices: function () {
    ...
    for (; featureIndex < featureMax; featureIndex++) {
      ...
      indices = earcut(flat.vertices[j], [], flat.dimensions);


      if(flat.holes.length > 0){ // find all parcels that have a hole
        console.log("Parcel with a hole found: " + feature.properties.parcelpin); 
        console.log("Vertices: " + JSON.stringify(flat.vertices[j]));
      ...
      // Draw line coordinates again according to the original latitude and lng info
      lines = [];
  ...
  drawOnCanvas: function () {
    ...
    var gl = this.gl,
      ...
      canvas = this.canvas,
      map = settings.map,
      pointSize = Math.max(map.getZoom() - 2.0, 1.0),
